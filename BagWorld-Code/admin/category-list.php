...
<div class="col-md-10 content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <?php 
?>
                    <h4><a href="category-list.php?addCategory=hh" style="color: brown; text-decoration: underline;">Add categories </a></h4>
                    ...
                    <form action ="category-list.php?addCategory=hh" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="txtCateName" placeholder="Please enter a product category name" />
                        </div>

                        <button type="submit" name ="insertCategory" class="btn btn-warning">More </button>
                    ...
                    if ($res) {
                        while ($row = mysqli_fetch_array($res)) {
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleterow.php?idCate=<?php echo $row['cat_id']; ?>">Erase</a></td>
