		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					...
					<li><a href="category-list.php"><span class="glyphicon glyphicon-plane"></span> Product portfolio</a></li>
					<li><a href="brand-list.php"><span class="glyphicon glyphicon-cloud"></span> Product brands</a></li>
					...
					<li class="panel panel-default" id="dropdown">
						<a data-toggle="collapse" href="#dropdown-lvl2">
							<span class="fa fa-shopping-cart"></span> Order <span class="caret"></span>
						</a>
						...
						<div id="dropdown-lvl2" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="nav navbar-nav">
									<li><a href="cart-list.php">List of orders</a></li>
					...
					<li class="panel panel-default" id="dropdown">
						...
						<div id="dropdown-lvl3" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="nav navbar-nav">
									<li><a href="contact-list.php">Contact message</a></li>
									<li><a href="contact-new.php">Unread messages</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li><a href="slide.php" class="glyphicon glyphicon-th"><span ></span> Slide Show Manager</a></li>
