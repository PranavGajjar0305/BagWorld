...
if (isset($_GET['noimage'])) {
    $noimage = 'Please select valid images';
} else {
    $noimage = '';
}
?>
...
<div class="col-md-10 content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h4><a href="slide.php?addSlide=hh" style="color: brown; text-decoration: underline;">Add categories </a></h4>
                    ...
                    <form action ="slideadd.php"  enctype="multipart/form-data" method="POST">
                        <div class="form-group">
                            ...
                            <button type="submit" name ="addSlide" class="btn btn-warning">More </button>
            ...
            <?php
                ...
                <div style="float: right; " class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h4 style="color: brown; text-decoration: underline;">Edit directory </h4>
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleterow.php?idSlide=<?php echo $row['Slider_ID']; ?>">Erase</a></td>
