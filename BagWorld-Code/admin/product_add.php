 ...
 <div class="col-md-6 content">
		...
		<form action="productadd_back.php"  method="POST" name="form1" id="form1" enctype="multipart/form-data">
		     <div class="form-group">
		        ...
		        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Product's name"  name="namepro">
		      </div>
		      <div class="form-group">
		      ...
		      <div class="form-group">
		        <label>Enter the word for the customer to search</label>
		        <input class="form-control" name="keyword" placeholder="Enter search keywords" />
		      </div>
		      <div class="form-group">
		      ...
		      <div class="row">
		          <div class="col-md-6 col-sm-6 col-xs-6">
		            <button type="submit" name ="addProduct" class="btn btn-warning btn-block btn-lg">More</button>
		          </div>
		          <div class="col-md-6 col-sm-6 col-xs-6">
