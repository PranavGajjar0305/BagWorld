...
//Get product and then division via page   
if (isset($_POST["page"])) {
                ...
                <li style='width: 250px; margin-left: -24px; margin-top: -25px;'>
                    <figure>
                        ...
                        <figcaption>
                            ...
                            <h3 class='center lightyellow' style='font-size: 15px;'>Price: $pro_price Rs</h3><br>
                            <h5 style='color:  greenyellow;' class='center'>Describe: $pro_des</h5>
                        </figcaption>
                    </figure>
                </li>
                <h4 class='center' style='margin-top: -13px;'>$pro_title</h4>
                <h3 class='center lightyellow' style='    margin-top: 0px; font-size: 15px;'>Price: $pro_price Rs</h3><br>
                <button 
                                pid='$pro_id' 
...
<div style='z-index: 1;' id='detail' class='overlay'>
        <div class='popup_changepassword'>
            ...
            <div class='content'>
                ...
                <label>Product's name: <b style='color: #fe980f'>$pro_title</b></label><br>
                <label>Price: <b style='color: #fe980f'>$pro_price Rs</b></label><br>
        ...
        if ($count > 0) {
            echo "
                    <div class='alert alert-warning'>
                        ...
                        <b>The product already exists in <a style='color: red' href='cart.php'>cart</a> your!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
            ...
            if (mysqli_query($con, $sql)) {
                ...
                <div class='alert alert-success'>
                    ...
                    <b>Product has been added <a style='color: red' href='cart.php'>cart</a> !</b>
                </div>
                    ";
            }
        }
        ...
        if ($count1 > 0) {
            echo "
                    <div class='alert alert-warning'>
                        ...
                        <b>The product already exists in your cart!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
           ...
           <div class='alert alert-success'>
                ...
                <b>You are buying in guest mode !. You can login</b> or <a href='customer_registration.php' style='color: blue'> register </a> new account.</b>
            </div>
...
<div class='row'>
    ...
    <div class='col-md-3 col-xs-3'>$pro_price Rs</div>
</div>
";
                $no = $no + 1;
            } else {
        ...
        if (isset($_POST["cart_checkout"])) {
                ...
                <div class='row'>
                    ...
                    <div class='col-md-4'>
                        <h1 style=' margin-left: 43px;'>
                            <a href='#popup2' 
                            type='button'>
                                <img title='Payment here' src='images/pay.png' 
                                width='100px' 
                                height='60px'>
                            </a>
                        </h1>
                ...
                <div style='z-index: 9999;' id='popup2' class='overlay'>
                    <div class='pay_popup'>
                        ...
                        <div class='content'>
                            ...
                            <h5>Customer:<b style='color: blue'> $namepay $lastname</b></h5>
                            <h5>Address: <b style='color: blue'> $addresspay</b></h5>
                            <h5>Phone number: <b style='color: blue'> $phonepay</b></h5>
            ...
            echo "<table border='1'>
                <tr>
                    ...
                    <th class = 'center'> Product's name </th>
            ...
            echo "
                    ...
                    <tr>
                        <td colspan='3'><b style='color: blue'>Total Money</b></td>
                        <td><b style='color: blue'>$total_amt</b></td>
                    </tr>
                            </table>
                        </div>
                        <hr>  
                             <input  type='button' class='btn btn-primary1' id='buttonout' value='Export Bill'>
                    </div>
                </div>";
        }                                              //Profile
    }
...
if (isset($_POST["updateProduct"])) {
    ...
    <div class='alert alert-success'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        <b>Product has been updated ... Go back to <a style='color:red' href='index.php'> homepage </a> to continue buying! </b>
    </div>
    ";
    }
}
        ...
        echo "
            ...
            <div class='row'>
                ...
                <div class='col-md-1' style='margin-left: -47px; margin-top: 5px;'>
                    <a href=''>
                        <img src='images/reload.png' title='reloadad the page' style='width: 20px;'></a>
                </div>	
...
if (isset($_POST["outhistory"])) {
    ...
    <div class='alert alert-success'>
        ...
        <b>
            <a href='index.php'>
                <b style='color:red'>[Bag World]</b>
            </a> Payment success. See you!
        </b>
    </div> <script> alert ('[Bag World] Payment successful. See you soon!') </script>
    ";
    }
...
if (isset($_POST["deleteallguest"])) {
    ...
    <div class='alert alert-success'>
        ...
        <b>
            <a href='index.php'>
                <b style='color:red'>[Bag World]</b>
            </a>Deleted successfully. The system automatically refreshes the following cart <b>3s</b>...
        </b>
        <script type='text/javascript'>
            init_reload();
            function init_reload(){
