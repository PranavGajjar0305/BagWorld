                        ...
                        <div class="col-sm-6 ">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    ...
                                    <li><a href="tel:+84123456789"><i class="fa fa-phone"></i> 9876543210 </a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <ul class="nav navbar-nav">
                                        ...
                                        <div class="dropdown-menu function_for_user" style="width:500px; margin-left: -540px">
                                            <div class="panel panel-success">
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-md-3 col-xs-3">Numerical order</div>
                                                        <div class="col-md-3 col-xs-3">Items</div>
                                                        <div class="col-md-3 col-xs-3">Product's name</div>
                                    ...
                                    <li><a style="height: 37px;" href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user function_for_user_span"></span></a>
                                        <ul style="height: 130px;" class="dropdown-menu">
                                            ...
                                            <li><a href="" style="font-size: 17px; text-decoration:none; color:blue;"><span class="fa fa-refresh"> Change the password</a></li>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class=" mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li class="menuhover"><a href="">Wallets</a></li>
